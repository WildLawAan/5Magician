...
def main():
  ...
  //player_opening=instance.media_player_new()
  //media_opening=instance.media_new(opening)

 // player_opening.set_media(media_opening)
  
  //lcd_string(" kt music...",LCD_LINE_1)
  //lcd_string(" Happy new Ear!",LCD_LINE_2)
  ...
  while downloading:
      ...
      if GPIO.input(24) == 0 :
          ...
          if a == 3:
              ...
              lcd_string(" kt music...",LCD_LINE_2)
              player_opening.play()
