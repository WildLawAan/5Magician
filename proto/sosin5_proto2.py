...
def main():
  ...
  media=instance.media_new("ftp://192.168.0.107/music2/"+musicfolderlist[sunse1][sunse]+"/"+musicfolderlist[sunse1][2])
  ...
  while True:
      ...
      if (a==3):
          if GPIO.input(16) == 0 :
              sunse1=sunse1+1
              media=instance.media_new("ftp://192.168.0.107/music2/"+musicfolderlist[sunse1][sunse])
              player.set_media(media)
